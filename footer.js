class CustomFooter extends HTMLElement {
  connectedCallback() {
      ...
      <div class="footer-container">
        <div class="footer-about">
          ...
          <p class="text-sm text-gray-400">
            Fiataloknak készült modern fintech megoldás, ami egyszerűvé és érthetővé teszi a pénzügyeket.
          </p>
        ...
        <div class="footer-links">
          <h3>Navigáció</h3>
          <ul>
            <li><a href="/" target="_top">Kezdőlap</a></li>
            <li><a href="/about.html" target="_top">Rólunk</a></li>
            <li><a href="/financial-education.html" target="_top">Pénzügyi oktatás</a></li>
            <li><a href="/contact.html" target="_top">Kapcsolat</a></li>
          </ul>
        </div>
        ...
        <div class="footer-links">
          ...
          <ul>
            <li><a href="/terms.html" target="_top">Általános Szerződési Feltételek</a></li>
            <li><a href="/privacy.html" target="_top">Adatvédelmi irányelvek</a></li>
            <li><a href="/cookies.html" target="_top">Cookie szabályzat</a></li>
            <li><a href="/purchase.html" target="_top">Vásárlási feltételek</a></li>
          </ul>
        </div>
    ...
    // Biztosítjuk, hogy minden link működjön Shadow DOM-ban
